...
export default async function AttendancePage() {
  ...
  return <div className="flex flex-col gap-6"><header><h1 className="text-2xl font-extrabold">حضور و غیاب</h1><p className="text-muted">ثبت ورود و خروج و مشاهده وضعیت لحظه‌ای اعضا</p></header><AttendanceManager initialRecords={data.records} members={data.members} /></div>;
}
