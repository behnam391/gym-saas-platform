...
ZARINPAL_CALLBACK_URL=https://app-api.gordyar.ir/api/v1/payments/zarinpal/callback
APP_WEB_ORIGIN=https://app.gordyar.ir
KAVENEGAR_API_KEY=
KAVENEGAR_SENDER=
KAVENEGAR_ALLOWED_RECIPIENTS=
KAVENEGAR_DRY_RUN=true
SMTP_HOST=
